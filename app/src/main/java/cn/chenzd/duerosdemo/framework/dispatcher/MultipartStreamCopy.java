...
public class MultipartStreamCopy {
     ...
     */
    @Deprecated
    public MultipartStreamCopy(InputStream input, byte[] boundary, int bufSize) {
     ...
     * @since 1.3.1
     */
    public MultipartStreamCopy(InputStream input,
                               byte[] boundary,
                               int bufSize,
    ...
    public class ItemInputStream extends InputStream implements Closeable {
        ...
        private void findSeparator() {
            pos = MultipartStreamCopy.this.findSeparator();
            if (pos == -1) {
